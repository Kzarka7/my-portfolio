  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`w-full flex items-center justify-between px-4 md:px-8 py-2 lg:py-3 rounded-2xl border border-[var(--border-muted)] backdrop-blur-[50px] transition-all duration-300 ease-in-out ${
