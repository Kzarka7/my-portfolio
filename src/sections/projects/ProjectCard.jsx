        ...
        >
          ...
          <div style={{
            ...
            <div style={{
              ...
              color: "var(--primary-C2)", letterSpacing: "0.12em",
              zIndex: 10, pointerEvents: "none",
            }}>
          ...
          {/* ── Card body ── */}
          <div style={{ padding: "32px 36px", borderTop: "0.5px solid var(--border-2E)" }}>
            <div style={{
              ...
              <div>
                ...
                <div style={{ display: "flex", gap: "6px", flexWrap: "wrap" }}>
                  {project.roles.map((role) => (
                    <span key={role} style={{
                      fontFamily: "var(--font-barl)", fontSize: "16px",
                      color: "var(--primary)",
                      border: "0.5px solid var(--border-67)",
                      padding: "4px 12px", letterSpacing: "0.14em",
                      background: "var(--surface-blue-05)",
              ...
              <div style={{ display: "flex", gap: "10px", flexShrink: 0 }}>
                <a
                  ...
                  style={{
                    ...
                    border: githubHov ? "0.5px solid var(--border-67)" : "0.5px solid var(--border-3D)",
                ...
                <a
                  ...
                  style={{
                    ...
                    padding: "8px 14px", color: "var(--text-dark)",
                    background: liveHov ? "var(--primary)" : "var(--primary-C2)",
            ...
            {/* Divider */}
            <div style={{ height: "0.5px", background: "var(--border-2E)", marginBottom: "16px" }} />

            <p style={{
              fontFamily: "var(--font-body)", fontSize: "16px",
              color: "var(--text-gray)", lineHeight: 1.8,
